...
// 收款
#define  ShouKuanC				UIColorWithRGB(102,188,9)
#define  ShouKuanChars			UIColorWithRGB(211,211,211)
#define  ShouKuanDigital		UIColorWithRGB(178,178,178)
#define  ShouKuanEqual			UIColorWithRGB(255,166,1)
// 邀请
#define  YaoQingBlue			UIColorWithRGB(64,191,237)
#define  YaoQingBgBlue			UIColorWithRGB(153,230,254)
#define  YaoQingZtBlue			UIColorWithRGB(13,130,171)
...
//计算例子：大小写一样
//第一位
// F: 240   15*16       // 9: 144   9*16        // 3: 48    3*16
// E: 224   14*16       // 8: 128   8*16        // 2: 32    2*16
// D: 208   13*16       // 7: 112   7*16        // 1: 16    1*16
// C: 192   12*16       // 6: 96    6*16
// B: 176   11*16       // 5: 80    5*16
// A: 160   10*16       // 4: 64    4*16
